...
{ 
    ...
    public class InboxController : BaseController
    {
        ...
        #region Ctor
        public InboxController(IContactUsService contactUsService)
        {
        ...
        {
            var inboxs = _contactUsService.GetAll(); 
            return View("inboxsList", inboxs);
        }
        ...
        public ActionResult Details(string encodedId)
        {
            ...
            var model = _contactUsService.Get(id);
            if (model == null)
            {
                return HttpNotFound();
            }
